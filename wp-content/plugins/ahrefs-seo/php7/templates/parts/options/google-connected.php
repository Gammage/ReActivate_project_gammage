...
?>
<form method="post" action="" class="ahrefs-seo-wizard ahrefs-analytics <?php if ( $incorrect_account ) { ?> gsc-no-account<?php } if ( $locals['preselect_accounts'] ) { ?> autodetect<?php } // phpcs:ignore Squiz.ControlStructures.ControlSignature.NewlineAfterOpenBrace ?>">
	...
	<div class="button-wrap">
		<a href="#" class="button button-hero button-primary" id="ahrefs_seo_submit" <?php disabled( ! $connected ); ?>><?php echo esc_html( $locals['button_title'] ); ?></a>
	</div>
</form>
<?php
if ( $locals['preselect_accounts'] ) {

...
<form method="post" action="" class="ahrefs-seo-wizard ahrefs-token">
	...
	<div class="card-item">
		...
		if ( $is_free_plan ) {
			...
			<div class="account-row"><span class="account-title">Plan</span><span class="account-value"><?php echo esc_html( $plan ); ?></span></div>
			<div class="account-row"><span class="account-title">Data rows</span><span class="account-value"><?php echo esc_html( $rows_left ); ?></span></div>

<?php
/**
 * Settings Notifications part template
 *
 * @var bool $updated
 */
...
<div class="input-wrap">
	<input id="allow_reports" type="checkbox" name="allow_reports" value="1" class="checkbox-input" <?php checked( isset( $locals['enabled'] ) ? $locals['enabled'] : true ); ?>>

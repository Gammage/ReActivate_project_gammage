...
<div class="block-schedule-checkbox">
	<label><input type="checkbox" name="schedule_enabled" value="1"<?php checked( $enabled ); ?>>Run scheduled content audits</label>
...
<div>
	...
	if ( $enabled ) {
		?>
		<p>The next content audit run is scheduled in: <?php echo esc_html( human_time_diff( $time_now, $next['time'] ) ); ?>.</p>
		<?php
	}
	?>
</div>

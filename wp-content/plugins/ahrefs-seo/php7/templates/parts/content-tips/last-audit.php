...
<div class="ahrefs-content-tip" id="last_content_audit_tip">
	...
	<div class="buttons">
		<a
			class="run-audit-button button button-primary manual-update-content-link<?php if ( $locals['no_ahrefs_account'] || $locals['no_google_account'] ) { ?> disabled<?php } // phpcs:ignore Squiz.ControlStructures.ControlSignature.NewlineAfterOpenBrace ?>"

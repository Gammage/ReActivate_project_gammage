...
<div class="ahrefs-header-wrap">
	<div class="ahrefs-header">
		...
		<div>
			...
			<span class="header-hint"><?php echo esc_html( $stat['last_time'] ); ?></span>
		</div>
		<div class="content-right">
			...
			<div id="content_audit_status" class="<?php echo esc_attr( $stat['in_progress'] ? 'in-progress' : '' ); ?><?php echo esc_attr( $paused ? ' paused' : '' ); ?>">
				<a
					class="run-audit-button button-orange manual-update-content-link<?php if ( $locals['no_ahrefs_account'] || $locals['no_google_account'] || $locals['ahrefs_limited'] ) { ?> disabled<?php } // phpcs:ignore Squiz.ControlStructures.ControlSignature.NewlineAfterOpenBrace ?>"
					href="#">Run new audit</a>
				<a
					class="paused-audit-button button-dark <?php if ( $locals['no_ahrefs_account'] || $locals['no_google_account'] || $locals['ahrefs_limited'] ) { ?> disabled<?php } // phpcs:ignore Squiz.ControlStructures.ControlSignature.NewlineAfterOpenBrace ?>"
					href="#">Audit paused</a>

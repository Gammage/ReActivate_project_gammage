...
class Ahrefs_Seo_Api extends Ahrefs_Seo_Abstract_Api {
	 ...
	 */
	public function get_backlinks_count_by_url( string $url, string $start_date, string $end_date, int $limit = 1000 ) : ?int {
	...
	private function fail_counter_update( bool $increase = true ) : void {

...
class Ahrefs_Seo_Token {
	 ...
	 */
	public static function get() : Ahrefs_Seo_Token {
	 ...
	 * @return void
	 */
	public function token_save( string $token ) : void {
	 ...
	 */
	public function token_get() : string {
	 ...
	 */
	public function token_state_ok() : bool {
	 ...
	 */
	private function token_state_set( bool $ok ) : bool {
	 ...
	 * @return string Url.
	 */
	public function token_link() : string {
	 ...
	 * @return string Url.
	 */
	public function token_free_link() : string {
	 ...
	 */
	public function query_api_is_token_valid() : bool {

...
abstract class Worker_Any {
	...
	protected const OPTION_PREFIX_WAIT   = 'ahrefs-seo-worker-wait';
	protected const OPTION_PREFIX_LOCK   = 'ahrefs-seo-worker-lock';
	 ...
	 */
	public function __construct( Content_Audit $content_audit, $api, bool $is_cron = false ) {
	 ...
	 * @return string
	 */
	protected function get_lock_name( int $post_id ) : string {
	 ...
	 * @return void
	 */
	private function lock_posts( array $post_ids ) : void {
		array_walk(
			$post_ids,
	 ...
	 * @return void
	 */
	private function unlock_posts( array $post_ids ) : void {
		array_walk(
			$post_ids,
			function( int $post_id ) : void {
	 ...
	 * @return bool
	 */
	private function is_locked_post( int $post_id ) : bool {
	 ...
	 */
	abstract protected function update_posts( array $post_ids ) : bool;
	 ...
	 * @return void
	 */
	abstract public function update_posts_info( array $post_ids ) : void;

...
class Content_Tips_Content extends Content_Tips_Any {
	...
	protected const OPTION_TIP_CLOSED    = 'ahrefs-seo-content-tip-closed-content';
	protected const OPTION_NOT_FIRST_TIP = 'ahrefs-seo-content-tip-first-tip-content';
	 ...
	 */
	public function maybe_return_tip( string $first_or_sub ) : ?string {
	 ...
	 * @return bool
	 */
	private function is_not_first_tip() : bool {

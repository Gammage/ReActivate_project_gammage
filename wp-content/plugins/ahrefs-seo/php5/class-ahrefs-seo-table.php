...
class Ahrefs_Seo_Table extends \WP_List_Table {
	...
	public function ajax_response() {
		...
		$this->prepare_items();
		$total_items = isset( $this->_pagination_args['total_items'] ) ? $this->_pagination_args['total_items'] : null;
		$total_pages = isset( $this->_pagination_args['total_pages'] ) ? $this->_pagination_args['total_pages'] : null;
		ob_start();
		...
		if ( isset( $_REQUEST['estimate'] ) ) {
			$response['estimate'] = Ahrefs_Seo_Data_Content::get()->get_estimate_rows();
		}
	 ...
	 *
	 * @param array<int, int>      $ids Associative array [ post_id => ver ].

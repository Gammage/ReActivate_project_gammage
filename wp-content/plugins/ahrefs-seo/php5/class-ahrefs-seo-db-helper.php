...
class Ahrefs_Seo_Db_Helper {
	 ...
	 */
	public static function get_updated_items( $table_alias, $field_id, array $items, $additional_where = '' ) {
		global $wpdb;
	 ...
	 */
	public static function content_data_get_clear_months( $snapshot_id, $type, $category, $search_string = '' ) {
		global $wpdb;

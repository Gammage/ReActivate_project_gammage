...
<div class="chart small-bottom">
	<div class="bg">
		...
		<div class="oval">
			<div class="score-number" data-score="<?php echo esc_attr( $score_data ); ?>">
				<?php
				echo esc_html( (string) round( 100 * $score ) );
				?>
			</div>
		</div>
	...
	<div class="score-legend">
		<?php
		echo esc_html( (string) $count[ Ahrefs_Seo_Charts::CHART_WELL_PERFORMING ] );
		?>
		 well performing pages out of 
 <?php

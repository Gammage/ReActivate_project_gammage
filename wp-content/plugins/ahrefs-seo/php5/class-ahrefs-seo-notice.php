...
class Ahrefs_Seo_Notice {
	...
	const OPTION_ADMIN_NOTICES             = 'ahrefs-seo-admin-notices';
	 ...
	 */
	public static function get( Ahrefs_Seo_View $view = null ) {
	 ...
	 */
	public function __construct( Ahrefs_Seo_View $view = null ) {
		$this->view = $view;
	 ...
	 * @return void
	 */
	public function set_audit_stopped( $is_stopped = true, $stopped_by_timeout = true ) {
	 ...
	 * @return void
	 */
	public function maybe_show_audit_stopped( $force_show = false ) {
		// do not show at own pages, only at Content Audit.
							...
							$( document ).on( 'click', '.ahrefs_seo_notice .notice-dismiss, .ahrefs-content-tip .notice-dismiss', function() {
								...
								$.post(
									ajaxurl,
									{
										...
										_wpnonce : '
										<?php
										echo esc_js( wp_create_nonce( $this->get_nonce_name() ) );
										?>
			',
									}
								);
	 ...
	 */
	public function ajax_notice_hide() {
